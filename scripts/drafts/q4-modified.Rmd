...
```{r}
setwd('C:/Users/Johnson Leung/Documents/GitHub/module1-group-2')
biomarker_clean = read_csv('data/biomarker-clean.csv', show_col_types = FALSE)
...
The model achieves an accuracy of 0.779 with 4 predictor proteins.
