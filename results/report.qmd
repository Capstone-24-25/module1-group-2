...
Fuzzy Intersection: We tried to merge the two variable importance results (p-adjusted, and MeanDecreaseGini)
We did this by min-max normalizing both of them and adding them together to get a combined score. 
The top 10 protiens with the highest combined score were selected. (Code above)
